...
import static app.security.SecurityUtils.AUTHORITIES_CLAIM;
import static app.security.SecurityUtils.JWT_ALGORITHM;
import static app.security.SecurityUtils.USER_ID_CLAIM;

import app.security.DomainUserDetailsService.UserWithId;
